  ...
  const EmptyCart = () => {
    return (
      <div className="container">
        <div className="row">
          <div className="col-md-12 py-5 text-center bg-maroon">
      ...
      <div className="container py-5">
        <div className="row my-4">
          <div className="col-md-5 col-lg-4 order-md-last">
            <div className="card mb-4 bg-dark-blue text-light">
              <div className="card-header py-3 bg-dark-lavender">
                ...
                <form className="needs-validation" novalidate>
                  <div className="row g-3">
                    ...
                    <div className="col-12 my-1">
                      ...
                      <div className="invalid-feedback">Please enter your delivery address.</div>
                    </div>
                  ...
                  <button className="w-100 btn btn-maroon" type="submit" disabled>
  ...
  return (
    <>
      ...
      <div className="container my-3 py-3">
        <h1 className="text-center text-light">Checkout</h1>
        <hr />
